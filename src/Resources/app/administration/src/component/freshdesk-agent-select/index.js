        ...
        async loadOptions() {
            ...
            try {
                ...
                if (!Array.isArray(agents) || agents.length === 0) {
                    agents = await this.freshdeskLookupApiService.getAgents(salesChannelId);
                }

                this.options = Array.isArray(agents)
                    ? agents
                ...
                this.createNotificationError({
                    title: 'Freshdesk',
                    message: 'Failed to load Freshdesk agents. Please check API URL/API key for this sales channel.',
                });
            } finally {
